...
import { CodexSocketIoTransport } from "../client/CodexSocketIoTransport.js";
import type {
  CodexTransport,
...
import { AppServerClient, type AppServerClientOptions } from "./AppServerClient.js";
import type { CodexProtocolMiddlewareStackFactory } from "../middlewares/index.js";
import { createCodexMiddlewareTransport } from "./middlewareTransport.js";
...
export type AppCodexMiddlewareTransportOptions = {
  createMiddlewareStack: CodexProtocolMiddlewareStackFactory;
...
export async function createManagedCodexBackendTransport(
  ...
  const transport = createAppCodexMiddlewareTransport(client, {
    createMiddlewareStack: options.createMiddlewareStack,
    hydrateRequestResponses: options.hydrateRequestResponses,
