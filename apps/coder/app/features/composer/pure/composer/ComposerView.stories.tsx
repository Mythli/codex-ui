...
export const WithAttachments: Story = {
  args: {
    attachments: [
      { id: "a1", kind: "file", mimeType: "text/markdown", name: "notes.md", path: "/tmp/notes.md", size: 8_000 },
      { id: "a2", kind: "image", mimeType: "image/png", name: "screen.png", path: "/tmp/screen.png", size: 940_000, dataUrl: screenPreview }
    ],
    canSubmit: true,
