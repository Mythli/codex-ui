...
import type { CoderInitialData } from "./store/reducers/initialData";
import {
  normalizeInitialReasoningEffort,
...
export async function loadCoderInitialData(input: LoadCoderInitialDataInput = {}): Promise<CoderInitialData> {
  ...
  async function loadConfig() {
    ...
    return {
      ...
      reasoningEffort: normalizeInitialReasoningEffort(response.config.model_reasoning_effort)
    };
  }
