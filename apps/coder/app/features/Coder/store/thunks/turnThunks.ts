...
import type { CoderComposerAttachment } from "../../../../coderui/features/CoderCore/types";
import type { AppThunk } from "../index";
import { attachmentsCleared, composerPromptCleared } from "../slices/composerSlice";
import { threadSelected } from "../slices/selectionSlice";
import { threadUnreadCleared } from "../slices/chatListMetaSlice";
import { createProvisionalThread } from "../slices/threadsSlice";
import { codexTrafficReceived } from "../actions/codexTrafficActions";
import type { CoderSubmitPromptResult } from "../types";

type MessageInput = string | CodexParsedUserInput[];
