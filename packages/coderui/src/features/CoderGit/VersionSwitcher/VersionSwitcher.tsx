    ...
    >
      {({ close }) => (
        <>
          ...
          <div className={[styles.list, "coder-scrollbar-thin"].join(" ")}>
                ...
                {commits.map((commit, index) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                    >
                      <FiGitBranch aria-hidden="true" className={styles.icon} />
                      <span className={styles.body}>
                        ...
                        <span className={styles.meta}>{formatCommitMeta(commit)}</span>
                      </span>
                      {isPending ? (
                        ...
                        <FiCheck aria-hidden="true" className={styles.check} />
                      ) : (
                        <span />
                      )}
                    </button>
